...
function createAliasedBinding({ factory, typescript, lexicalEnvironment, name, node, propertyName, typeChecker }) {
    ...
    switch (declaration === null || declaration === void 0 ? void 0 : declaration.kind) {
        ...
        case typescript.SyntaxKind.ClassExpression: {
            return [
                preserveParents(factory.createModuleDeclaration(undefined, undefined, factory.createIdentifier(moduleBinding), factory.createModuleBlock([
                ...
                preserveParents(factory.createImportEqualsDeclaration(undefined, undefined, false, factory.createIdentifier(name), factory.createQualifiedName(factory.createIdentifier(moduleBinding), factory.createIdentifier(propertyName))), { typescript })
            ];
        }
        ...
        case typescript.SyntaxKind.ExportAssignment: {
            return [
                preserveParents(factory.createVariableStatement(ensureHasDeclareModifier(undefined, factory, typescript), factory.createVariableDeclarationList([factory.createVariableDeclaration(factory.createIdentifier(name), undefined, factory.createTypeQueryNode(factory.createIdentifier(propertyName)))], typescript.NodeFlags.Const)), { typescript })
            ];
        }
        default: {
            return [
                preserveParents(factory.createTypeAliasDeclaration(undefined, undefined, factory.createIdentifier(name), undefined, factory.createTypeReferenceNode(factory.createIdentifier(propertyName), undefined)), { typescript })
            ];
        }
    }
}
...
function visitImportSpecifier$1(options) {
    ...
    if (exportedSymbol != null) {
        ...
        if (exportedSymbol.moduleSpecifier != null &&
            ...
            options.prependNodes(...createAliasedBinding(Object.assign(Object.assign({}, options), { node: declaration, propertyName: exportedSymbol.propertyName.text, name: contResult.name.text })));
        }
    }
...
function visitExportSpecifier(options) {
    ...
    if (namedExportedSymbol != null) {
        ...
        if (namedExportedSymbol.moduleSpecifier != null &&
            ...
            return preserveMeta(factory.updateExportSpecifier(contResult, false, !("propertyName" in namedExportedSymbol) || namedExportedSymbol.propertyName == null || namedExportedSymbol.propertyName.text === contResult.name.text
                ? undefined
                : factory.createIdentifier(namedExportedSymbol.propertyName.text), factory.createIdentifier(contResult.name.text)), contResult, options);
        }
    }
...
function visitImportClause$1(options) {
    ...
    if (defaultExportedSymbol != null) {
        ...
        // If they don't, we'll need to alias it
            ...
            options.prependNodes(...createAliasedBinding(Object.assign(Object.assign({}, options), { node: declaration, propertyName: defaultExportedSymbol.propertyName.text, name: contResult.name.text })));
        }
    }
 ...
 */
function getSwcConfigFactory({ fileSystem, swcConfig, cwd, browserslist, phase, hook }) {
    ...
    return filename => {
        ...
        const config = Object.assign(Object.assign({}, inputConfig), { module: Object.assign(Object.assign({}, inputConfig.module), FORCED_SWC_MODULE_OPTIONS), jsc: Object.assign(Object.assign(Object.assign({ 
                // Loose breaks things such as spreading an iterable that isn't an array
                loose: false }, inputConfig.jsc), { parser: Object.assign({ syntax: "ecmascript", jsx: false }, (_a = inputConfig.jsc) === null || _a === void 0 ? void 0 : _a.parser) }), FORCED_SWC_JSC_OPTIONS), env: Object.assign({}, (browserslist == null
                ? inputConfig.env
                : Object.assign({ 
                    // Loose breaks things such as spreading an iterable that isn't an array
            ...
            // Always parse things as modules. Rollup will then decide what to do based on the output format
            isModule: true });
        return (_b = hook === null || hook === void 0 ? void 0 : hook(config, filename, phase)) !== null && _b !== void 0 ? _b : config;
    };
}
...
function typescriptRollupPlugin(pluginInputOptions = {}) {
    ...
    return {
        name: PLUGIN_NAME,
        /**
         * Warn about the package being deprecated on build to help clients know they're sitting on an unmaintained legacy version of the package
         */
        buildStart() {
            this.warn(`WARNING: @wessberg/rollup-plugin-ts has been renamed to rollup-plugin-ts. The old version of the package that you're currently using is not fully compatible with the latest TypeScript versions.\nPlease depend on rollup-plugin-ts instead to remove this warning or stay on @wessberg/rollup-plugin-ts@1.3.14`);
        },
        /**
